...
export const en: Translations = {
  ...
  modelDetails: {
    ...
    active: 'active',
    use: 'Use',
    expand: 'Show benchmark spread',
    collapse: 'Hide benchmark spread',
    ctx: 'ctx',
    throughputAt64k: 'Throughput at 64K context (Dyno bench)',
    operatingCtx: 'Operating context',
    fitsGpu: 'fits GPU',
    spillsGpu: 'spills VRAM',
    notBenched: 'not benched',
    live: 'live',
    liveHint: 'Observed throughput from real turns (average of recent samples)',
    diverges: 'off bench',
    divergesHint: 'Real observed throughput differs from the bench figure by >20%',
    prefill: 'prefill',
    gpu: 'GPU',
    load: 'load',
    benched: 'benched',
    noModels: 'No local models benched yet — run the Dyno to see KPIs.',
    unreachable: 'No local Ollama server answering.',
    noModel: 'no model',
    loaded: 'loaded',

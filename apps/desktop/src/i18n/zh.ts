...
export const zh: Translations = {
  ...
  modelDetails: {
    ...
    collapse: '收起基准数据',
    ctx: '上下文',
    throughputAt64k: '64K 上下文下的吞吐量（Dyno 基准）',
    operatingCtx: '运行上下文',
    fitsGpu: '完全载入 GPU',
    spillsGpu: '溢出显存',
    notBenched: '未测试',
    live: '实测',
    liveHint: '来自真实对话的观测吞吐量（近期采样平均值）',
    diverges: '偏离基准',
    divergesHint: '实测吞吐量与基准值相差超过 20%',
    prefill: '预填充',
    gpu: 'GPU',
    load: '加载',
    benched: '测试于',
    noModels: '尚无本地模型的基准数据——请运行 Dyno 查看 KPI。',
    unreachable: '没有可用的本地 Ollama 服务。',
    noModel: '无模型',
    loaded: '已加载',
    notLoaded: '未加载',
    pinned: '已固定',
